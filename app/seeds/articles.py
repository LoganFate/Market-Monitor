...
def seed_articles():
    articles_data = [
        Article(
            ...
            author='Jane Doe',
            article_url='https://example.com/future-of-technology',
            image_url='https://example.com/images/future-of-technology.jpg',
        ...
        Article(
            ...
            author='John Smith',
            article_url='https://example.com/finance-trends-2024',
            image_url='https://example.com/images/finance-trends-2024.jpg',
            published_utc=datetime.utcnow(),
        ...
        Article(
            ...
            author='Alex Johnson',
            article_url='https://example.com/healthcare-innovations',
            image_url='https://example.com/images/healthcare-innovations.jpg',
            published_utc=datetime.utcnow(),
        ...
        Article(
            ...
            author='Chris Lee',
            article_url='https://example.com/renewable-energy-sources',
        ...
        Article(
            ...
            author='Pat Kim',
            article_url='https://example.com/rise-of-consumer-goods',
            image_url='https://example.com/images/rise-of-consumer-goods.jpg',
            published_utc=datetime.utcnow(),
